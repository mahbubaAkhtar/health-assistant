...
<div class="container">
    <h1>Scabies Questionnaire Form</h1>
    ...
    <div class="pure_grid">
        <form id="surveyForm">
            ...
            <label for="itching">How long has the itching lasted?</label><br>
            <input type="number" id="itching" name="itching" required><br>

            <label for="itching">When does your itching mainly occur?</label><br>
            <input type="radio" id="itching" name="itching" value="yes">
            <label for="day">Day</label>
            <input type="radio" id="itching" name="itching" value="no" >
            <label for="night">Night</label>
            <input type="radio" id="itching" name="itching" value="no" >
            <label for="night">All Time</label><br>

            <label for="itch">Does anyone else in your householder have an itch?</label><br>
            <input type="radio" id="itch" name="itch" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="itch" name="itch" value="no">
