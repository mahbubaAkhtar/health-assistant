...
<div class="container">
    ...
    <div class="pure_grid">
        <form id="surveyForm">
            ...
            <label for="burned">The burned areas looking red?</label><br>
            <input type="radio" id="burned" name="burned" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="burned" name="burned" value="no" >
            <label for="no">No</label><br>

            <label for="burned">Having any problem other than the res & light pain in the burned area?</label><br>
            <input type="radio" id="burned" name="burned" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="burned" name="burned" value="no" >
            <label for="no">No</label><br>

            <label for="pain">Having pain in the burn area?</label><br>
            <input type="radio" id="pain" name="pain" value="yes">
            <label for="lightly_pain">Lightly Pain</label>
            <input type="radio" id="pain" name="pain" value="no">
            <label for="too_much_pain ">Too Much Pain</label><br>
