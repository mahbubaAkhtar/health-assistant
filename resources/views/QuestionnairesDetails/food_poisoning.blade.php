...
<div class="container">
    <h1>Food Poisoning Questionnaire Form</h1>
    ...
    <div class="pure_grid">
        <form id="surveyForm">
            ...
            <label for="day">how long is diarrhea?</label><br>
            <input type="number" id="day" name="day" required><br>

            <label for="time">How many times have you had diarrhea so far? </label><br>
            <input type="number" id="time" name="time" required><br>

            <label for="diarrhoea">Are you doing diarrhoea, which have contain blood or mucus?</label><br>
            <input type="radio" id="diarrhoea" name="diarrhoea" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="diarrhoea" name="diarrhoea" value="no" >
            <label for="no">No</label><br>

            <label for="vomiting">Are you vomiting?</label><br>
            <input type="radio" id="vomiting" name="vomiting" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="vomiting" name="vomiting" value="no">
            <label for="no">No</label><br>

            <label for="stomachPain">Do you have feel stomach pain?</label><br>
