...
<div class="container">
    <h1>Migraine Questionnaire Form</h1>
    ...
    <div class="pure_grid">
        <form id="surveyForm">
            ...
            <label for="headache">How long does your headache last?</label><br>
            <input type="number" id="headache" name="headache" required><br>

            <label for="headache">Are you feel intense throbbing head pain?</label><br>
            <input type="radio" id="headache" name="headache" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="headache" name="headache" value="no" >
            <label for="no">No</label><br>

            <label for="commonIssue">do you feel accompanied by nausea and vomiting, as well as sensitivity to light and sound?</label><br>
            <input type="radio" id="commonIssue" name="commonIssue" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="commonIssue" name="commonIssue" value="no">
            <label for="no">No</label><br>

            <label for="commonIssue">Do you have one-sided head pain?</label><br>
            <input type="radio" id="commonIssue" name="commonIssue" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="commonIssue" name="commonIssue" value="no">
            <label for="no">No</label><br>

            <label for="headInjuries">Have you had any head injuries?</label><br>
            <input type="radio" id="headInjuries" name="headInjuries" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="headInjuries" name="headInjuries" value="no">
            <label for="no">No</label><br>
