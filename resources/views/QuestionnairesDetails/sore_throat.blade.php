...
<div class="container">
    <h1>Sore Throat Questionnaire Form</h1>
    ...
    <div class="pure_grid">
        <form id="surveyForm">
            ...
            <label for="day">How long has the sore throat lasted?:</label><br>
            <input type="number" id="day" name="day" required><br>

            <label for="headache">Do you feel Pain when swallowing?</label><br>
            <input type="radio" id="headache" name="headache" value="yes">
            <label for="yes">Yes</label>
            <input type="radio" id="headache" name="headache" value="no" >
            <label for="no">No</label><br>

            <label for="Coldcough">Do yo see Red and swollen tonsils?</label><br>
